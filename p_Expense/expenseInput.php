    		...
    		<form name='inputForm' id='expenseInputForm' method='post' action='exe/exeExpense.php'
																...
																<table class='sheetTable1'>
																		...
																		<tbody>
																				<tr>
																						...
																						<td>
																						<input type='text' value='' name='date_".$i."' class='datepicker'>
																						</td>
						...
						<script type="text/javascript">
                                ...
                                jQuery(function($) {
									...
									var pl_11 = $(".pl_11"); // price list
									var pl_12 = $(".pl_12"); // price list
									var pl_13 = $(".pl_13"); // price list
									var pl_14 = $(".pl_14"); // price list
									var pl_15 = $(".pl_15"); // price list
									var pl_16 = $(".pl_16"); // price list
									var pl_17 = $(".pl_17"); // price list
									var pl_18 = $(".pl_18"); // price list
									var pl_19 = $(".pl_19"); // price list
									var pl_20 = $(".pl_20"); // price list
									...
									var rt_11 = $(".rt_11"); // rate
									var rt_12 = $(".rt_12"); // rate
									var rt_13 = $(".rt_13"); // rate
									var rt_14 = $(".rt_14"); // rate
									var rt_15 = $(".rt_15"); // rate
									var rt_16 = $(".rt_16"); // rate
									var rt_17 = $(".rt_17"); // rate
									var rt_18 = $(".rt_18"); // rate
									var rt_19 = $(".rt_19"); // rate
									var rt_20 = $(".rt_20"); // rate
									...
									var tot_11 = $(".tot_11"); // total of pricelist x rate
									var tot_12 = $(".tot_12"); // total of pricelist x rate
									var tot_13 = $(".tot_13"); // total of pricelist x rate
									var tot_14 = $(".tot_14"); // total of pricelist x rate
									var tot_15 = $(".tot_15"); // total of pricelist x rate
									var tot_16 = $(".tot_16"); // total of pricelist x rate
									var tot_17 = $(".tot_17"); // total of pricelist x rate
									var tot_18 = $(".tot_18"); // total of pricelist x rate
									var tot_19 = $(".tot_19"); // total of pricelist x rate
									var tot_20 = $(".tot_20"); // total of pricelist x rate
                                	// (A) END
                            		...
                            		{   var ResultA;
                            		    ResultA = 
											...
											parseFloat(tot_11.val()) +
											parseFloat(tot_12.val()) +
											parseFloat(tot_13.val()) +
											parseFloat(tot_14.val()) +
											parseFloat(tot_15.val()) +
											parseFloat(tot_16.val()) +
											parseFloat(tot_17.val()) +
											parseFloat(tot_18.val()) +
											parseFloat(tot_19.val()) +
                                		    parseFloat(tot_20.val());
