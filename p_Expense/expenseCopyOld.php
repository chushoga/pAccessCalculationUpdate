...
if (isset($_GET['id'])){
    ...
    $setQuery = "SELECT * FROM `expense` WHERE `id` LIKE '%$search%' OR `forwarder` LIKE '%$search%' OR `date` LIKE '%$search%'";
}
				...
				<div class='contents'>
						...
						<?php if ($record <= 0){?>
								...
								<button class='recordCycleBtn'
										onClick="location.href='expense.php?pr=3&record=<?php echo $previous;?>&search=<?php echo $search;?>'">◀
								</button>
								...
								<button class='recordCycleBtn'
										onClick="location.href='expense.php?pr=3&record=<?php echo $next;?>&search=<?php echo $search;?>'">▶
								</button>
												...
												<div class='sheetWrapper'>
														...
														<div class='sheetTop'>
																...
																<div class='sheetTopBox1forwarderWrapper'>
																		...
																		<div class='sheetTopBox1forwarderBottom'
																				id='quickFit1'>
																				<?php echo $forwarder;?>
																		</div>
																</div>
																...
																<div class='sheetTopBox1VesPackWrapper'>
																		<div class='sheetTopBox1VesPackTop'
																				style='border-right: 1px solid #CCC;''>梱包/コンテナー</div>
																		<div class='sheetTopBox1VesPackBottom'
																				style='border-right: 1px solid #CCC;' id='quickFit3'>
																				<?php echo $packing;?>
																		</div>
																</div>
																<div class='clear'></div>
																<div class='sheetTopBox2'>
																		...
																		<table class='sheetTable1'>
                                                                                ...
                                                                                <td><b>$subMaker Total/AV222</b></td>
                                                                                <td><b>";
														             ...
														             // echo $subtotRateDiv."<br><hr><br>";
														              //-----------------------------------
                                                                        ...
                                                                        <tr>
                                                                        <td style='border-left: none;'></td>
                                                                        <td><b>$subMaker Total/AV111</b></td>
                                                                        <td><b>";
																				    $makerSingleArray[$subMaker] = $subtotRateDiv;
												            ...
												            */
												            ...
												            //----------------------------
																		...
																		<div class='sheetTopTotal'>
																				<p>
																						合計 (A) <span class='greenText'>￥<?php echo number_format($z, 0, '.',',');?>
																						</span>
																				</p>
																				<hr>
																				<p>
														...
														<div class='sheetBottom'>
																...
																<table class='sheetTable2'>
																		...
																		<tbody>
																				<tr>
																						<td></td>
																						<td class='aRight'>消費税 (<?php echo $jpRate*100; echo "%";?>)
																								￥<?php echo number_format(intval($consumptionTaxTotal), 0, '.', ',');?>
																						</td>
																				</tr>
																				<tr>
																						<td></td>
																				...
																				<tr>
																						<td></td>
																						<td class='aRight'><span style='text-align: left;'>合計輸入消費税(C)
																						</span><span class='greenText'>￥<?php echo number_format($consumptionTotal, 0, '.', ',');?>
																						</span></td>
																				</tr>
																				<tr>
										    ...
										    foreach ($orderArray as $value => $key){ 
										        ...
										        if ($key != ''){
										            ...
										            foreach ($allArray as $value1){
										               // echo $key." <--key<br>";
										               // echo $value1['maker']." | ".$key." | ".$value1['rate']."<br>";
										                
										                if ($value1['orderNo'] == $key){
										                    //echo $key;
										                    
										            //    foreach ($makerSingleArray as $item => $keyItem){
										               // echo "[Item: ".$item." ]";
										              //  echo "[Key: ".$keyItem." ]<br>";
										          //      if ($key == $keyItem){
										                  //  echo "use thise";
