    	...
    	<div class='contents'>
            ...
            ?>
                    <div class='cancelBtn'
                            ...
                            onClick="location.href='expense.php?pr=3&id=<?php echo $id;?>'">キャンセル</div>
                </div>
                <!-- EDIT BAR FINISHED -->
                                    ...
                                    <div class='sheetTopBox2'>
                                            ...
                                            <table class='sheetTable1'>
                                                    ...
                                                    <tbody>
															...
															echo "<td><input type='text' value='".$row['date_'.$i]."' name='date_".$i."' class='datepicker'></td>";
            ...
            <form method="post" action="exe/delExpense.php">
                ...
                <div class="editBar">
                            <button class='delEntryBtn'
                                ...
                                onclick="return(YNconfirm(<?php echo $id; ?>)); ">削除</button>
                </div>
                <div class='clear'></div>
            <br>
            </form>
