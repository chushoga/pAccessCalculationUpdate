...
.hidden { /*Opacity settings for all browsers*/
        opacity: 0;
        -moz-opacity: 0;
...
@media print {
        ...
        #header,input, #statusBar, .footer,p  * {
    	...
    	<div class='tfProjectContents'>
						...
						?>
								<div class='tableWrapper'>
										<div id='saveWrapper'>
										<table class="tg" style='width: 100%; background-color: #FFF; table-layout: fixed;' >
												<colgroup>
												...
												while ($row = mysql_fetch_assoc($result)){
												    ...
												    echo "<tr class='headerTop'>
													    <th class='tg-s6z3 colM'  style='background-color: #CCC;'>id</th>
													    <th class='tg-s6z3 colN'  style='background-color: #CCC;'>プロジェクト名</th>
													    <th class='tg-s6z3 colO'  style='background-color: #CCC;'>現場住所</th>
													    <th class='tg-s6z3 colP'  style='background-color: #CCC;'>date</th>
													    <th class='tg-031e colQ'  style='border: none;'></th>
													</tr>
													<tr>
														<td class='tg-s6z2'>".$row['id']."</td>
														<td class='tg-s6z2'>".$row['projectName']."</td>
														<td class='tg-s6z2'>".$row['place']."</td>
