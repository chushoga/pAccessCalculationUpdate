...
// ------------------------------------------------------------------
            				...
            				if ($isSet == false){
                                ...
                                if( count($plHistoryBaiAdd1) >= 2){
                    				if(($plHistoryBaiAdd1[0] != 0 AND $plHistoryBaiAdd1[1] != 0)){
                        				...
                        				echo "<span style='".$colorThan."'>".number_format($plHistoryBaiOut, 2, '.','')."%</span>";
                    				} else {
                    				    echo "履歴なし";
                    				}
                                } else {
    ...
    // START OF SET LOOP
    				        ...
    				        $i++;
            				    ...
            				    if ($sp_disc_rate_id != 0){
            				    echo "￥".$single_rate."/".$single_percent."%";
            				    } else {
            				        echo " - ";
            				    }
            				//DISPLAY THE CORRRECT RATE TO MATCH THE CURRENCY
            				    if ($sp_disc_rate_id != 0){
                				        ...
                				        echo "<span class='rateDiscountColor'>￥".$single_pref_rate."/".$single_pref_percent."%</span>";
                				        } else {
    				        ...
    				        $i++;
            				      ...
            				      if ($sp_disc_rate_id != 0){
            				    echo "￥".number_format(truncate($single_purchasePrice,0), 0, '',',');
            				      } else {
            				          echo " - ";
            				      }
        				...
        				".$inputPrice2."<input type='hidden' name='".$listTformNoId."' value='".$inputPrice."' style='width: 60px; text-align: right; ".$isTestPrice." ' class='inputVal".$t."'>";
